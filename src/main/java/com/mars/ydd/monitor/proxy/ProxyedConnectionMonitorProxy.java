...
public class ProxyedConnectionMonitorProxy implements Connection {
	 private final Connection connection;
	    ...
	    public ProxyedConnectionMonitorProxy(Connection connection, MonitorDataProcessor monitorDataProcessor) {
	        super();
