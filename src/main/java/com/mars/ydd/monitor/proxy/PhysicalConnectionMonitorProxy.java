...
public class PhysicalConnectionMonitorProxy implements Connection {
    ...
    public PhysicalConnectionMonitorProxy(Connection connection, MonitorDataProcessor monitorDataProcessor) {
        super();
