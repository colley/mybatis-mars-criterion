...
public class CallableStatementMonitorProxy extends PreparedStatementMonitorProxy implements CallableStatement {
	 private final CallableStatement callableStatement;

	    public CallableStatementMonitorProxy(CallableStatement callableStatement,
	            MonitorDataProcessor monitorDataProcessor, String sql) {
	        super(callableStatement, monitorDataProcessor, sql);
